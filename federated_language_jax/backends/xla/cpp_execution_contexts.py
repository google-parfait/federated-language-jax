...
from federated_language_jax.environments.jax_frontend import jax_computation
from federated_language_jax.environments.xla_backend import xla_executor_bindings
...
def create_async_local_cpp_execution_context(
  ...
  def _compile(comp):
    return tensorflow_federated.backends.native.transform_to_native_form(comp)
