...
class XLAExecutorTest : public ::testing::Test {
 public:
  ...
  void CheckMaterializeEqual(
      ...
      federated_language_executor::Value expected_result) {
  ...
  void CheckRoundTrip(federated_language_executor::Value& input_pb) {
  ...
  void CheckRoundTripFails(federated_language_executor::Value& input_pb,
                           ::testing::Matcher<absl::Status> status_matcher) {
    TFF_ASSERT_OK_AND_ASSIGN(tensorflow_federated::OwnedValueId id,
                             test_executor_->CreateValue(input_pb));
    federated_language_executor::Value output_pb;
...
TEST_F(XLAExecutorTest, RoundTripStructWithTensor) {
  ...
  federated_language_executor::Value value_pb;
  value_pb.mutable_array()->Swap(&array_pb);
  federated_language_executor::Value input_pb = StructV({value_pb});
...
TEST_F(XLAExecutorTest, CreateSelectionFromCreateValue) {
  ...
  federated_language_executor::Value value2_pb;
  value2_pb.mutable_array()->Swap(&array2_pb);
  federated_language_executor::Value input = StructV({value1_pb, value2_pb});
...
TEST_F(XLAExecutorTest,
  ...
  *function_type.mutable_function()->mutable_parameter() =
  ...
  federated_language_executor::Value computation = ComputationV(
...
TEST_F(XLAExecutorTest, CreateValueComputationLiteralReturnsResult) {
  ...
  federated_language_executor::Value expected_pb;
...
TEST_F(XLAExecutorTest, CreateAndMaterializeNoArgCallSingleTensor) {
  ...
  xla::ConstantR0<float>(&builder, 1.0);  // NOLINT
  absl::StatusOr<xla::XlaComputation> xla_computation = builder.Build();
  ASSERT_TRUE(xla_computation.ok());
...
TEST_F(XLAExecutorTest, CreateAndMaterializeIdentitySingletonStruct) {
  ...
  federated_language_executor::Value value_pb;
  value_pb.mutable_array()->Swap(&array_pb);
  federated_language_executor::Value arg_value = StructV({value_pb});
  TFF_ASSERT_OK_AND_ASSIGN(tensorflow_federated::OwnedValueId embedded_fn,
                           test_executor_->CreateValue(computation));
  TFF_ASSERT_OK_AND_ASSIGN(tensorflow_federated::OwnedValueId embedded_arg,
...
TEST_F(XLAExecutorTest, CreateAndMaterializeIdentityNestedStruct) {
  ...
  federated_language_executor::Value value3_pb;
  value3_pb.mutable_array()->Swap(&array3_pb);
  federated_language_executor::Value arg_value =
      StructV({value1_pb, StructV({value2_pb, value3_pb})});
  TFF_ASSERT_OK_AND_ASSIGN(tensorflow_federated::OwnedValueId embedded_fn,
                           test_executor_->CreateValue(computation));
  TFF_ASSERT_OK_AND_ASSIGN(tensorflow_federated::OwnedValueId embedded_arg,
...
TEST_F(XLAExecutorTest,
  ...
  federated_language_executor::Value value5_pb;
